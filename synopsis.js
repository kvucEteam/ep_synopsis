...
function returnLastStudentSession() {
    ...
    osc.init('studentSession_ep_synopsis');
    osc.exist('jsonData');
    ...
    if ((TjsonData !== null) && (typeof(TjsonData) !== 'undefined')) {
        //alert("Der ER TjsonData");
        console.log('returnLastStudentSession - getTimeStamp: ' + osc.getTimeStamp());
        
//***********************************************************************************
// HELE DENNE SEKTION ER KOMMENTERET UD, DA DEN GAV PROBLEMER MED AT GEMME WORD FILEN: 
//***********************************************************************************
        ...
        //alert("Der er ingen TjsonData"); // step_0_template();

        UserMsgBox("body", " <h4>Vi gemmer dit arbejde men..</h4><p> Vær opmærksom på, at dit arbejde er tilknyttet den browser, som du bruger lige nu. Det vil sige, at du ikke kan arbejde videre på en anden computer/browser. Hvis du sletter din historik i browseren, så sletter du også alt dit arbejde.</p>"); 
...
function template() {
    ...
    ++titelIndex;
    HTML += '<h2 class="info_hover"> Litteraturliste <span class="glyphicon glyphicon-info-sign"></span></h2>';
...
*/
    ...
    HTML += '<span id="delete" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-remove"></span> Slet felterne</span>';
    ...
    $(".info_hover").on('mouseover touchstart', function() {
        ...
        microhint($(this), infoArray[identifier]); //jsonData.templateData.introtekster[identifier]);
...
jsonData = getAjaxData("GET", "json/quizData.json", false, "json");
