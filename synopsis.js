...
function template() {
    ...
    ++titelIndex;
    HTML += '<h2 class="info_hover">' + titelLetter[titelIndex] + '. Konklusion <span class="glyphicon glyphicon-info-sign"></span></h2>';
    ...
    ++titelIndex;
    HTML += '<h2 class="info_hover">' + titelLetter[titelIndex] + '. Litteraturliste <span class="glyphicon glyphicon-info-sign"></span></h2>';
